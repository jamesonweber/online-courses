...
// Create a type for reading / writing to the console.
// This allows us to test functions which are dealing with the console because we can evaluate the
// data structure we have created by using a test interpreter (like Id).
const Console = taggedSum('Console', {Question: ['q'], Print: ['s']})

// Create a type for reading / writing to the database for the same reason
